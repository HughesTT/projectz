        ...
        <aside class="category-sidebar">
          ...
          <div class="category-scroll-wrapper">
            <ul ref="categoryList" class="category-list" @scroll="checkScroll">
              ...
              <li :class="{ active: selectedCategory === 'soundbar' }" @click="selectedCategory = 'soundbar'">
                <i class="bi bi-speaker"></i>
                SoundBar
              </li>
              <li :class="{ active: selectedCategory === '藍芽喇叭' }" @click="selectedCategory = '藍芽喇叭'">
                <i class="bi bi-bluetooth"></i>
                藍芽喇叭
              </li>
              <li :class="{ active: selectedCategory === '家庭劇院' }" @click="selectedCategory = '家庭劇院'">
                <i class="bi bi-bluetooth"></i>
                家庭劇院
              </li>
            </ul>
...
onMounted(async () => {
  ...
  selectedUnit.value = 'speaker' // 設置當前產品類型為喇叭
